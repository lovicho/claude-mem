...
- No cloud uploads (API calls only for AI compression). Local installs contact cmem.ai once, at signup, to create the sign-in link; nothing else is sent to cmem.ai.
